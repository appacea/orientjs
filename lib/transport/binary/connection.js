  ...
  return new Promise(function (resolve, reject) {
    this.socket.once('data', function (data) {
      ...
      if (this.protocolVersion >= 33) {
        //YSN: 05/09/2016 - replaced for our custom protocol with gremlin enabled
        //this.protocol = require('./protocol33');
        this.protocol = require('./protocol33_appacea');
      } else if (this.protocolVersion >= 28) {
        //YSN: 05/09/2016 - replaced for our custom protocol with gremlin enabled
        //this.protocol = require('./protocol28');
        this.protocol = require('./protocol28_appacea');
        ...
        this.protocol = require('./protocol26');
         ...
         this.protocol = require('./protocol19_appacea');
      }
